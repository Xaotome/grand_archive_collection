        ...
        try {
            ...
            $testCards = [
                [
                    ...
                    'speed' => null,
                    'element' => 'Norme',
                    'effect' => 'Draw a card. [Class Bonus] - Draw an **additional** card. **Powerful** magic flows through you.',
                    'effect_raw' => 'Draw a card. [Class Bonus] - Draw an **additional** card. **Powerful** magic flows through you.',
                    'effect_html' => '<p>Draw a card. [Class Bonus] - Draw an **additional** card. **Powerful** magic flows through you.</p>',
                ...
                [
                    ...
                    'speed' => null,
                    'element' => 'Norme',
                    'effect' => '[On Enter]: You may pay (2) and [REST]. If you do, this ally gets +1[POWER]. [Level 2]: Gain 1[LIFE].',
                    'effect_raw' => '[On Enter]: You may pay (2) and [REST]. If you do, this ally gets +1[POWER]. [Level 2]: Gain 1[LIFE].',
                    'effect_html' => '<p>[On Enter]: You may pay (2) and [REST]. If you do, this ally gets +1[POWER]. [Level 2]: Gain 1[LIFE].</p>',
                ...
                [
                    ...
                    'speed' => null,
                    'element' => 'Fire',
                    'effect' => '[Level 1]: Deal **1 damage** to target. [Class Bonus]: Deal **2 damage** instead. This effect cannot be **prevented**.',
                    'effect_raw' => '[Level 1]: Deal **1 damage** to target. [Class Bonus]: Deal **2 damage** instead. This effect cannot be **prevented**.',
                    'effect_html' => '<p>[Level 1]: Deal **1 damage** to target. [Class Bonus]: Deal **2 damage** instead. This effect cannot be **prevented**.</p>',
